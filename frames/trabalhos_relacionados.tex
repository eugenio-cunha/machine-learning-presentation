\section{Trabalhos Relacionados}
  \begin{frame}[fragile]{Matrizes de Referência}
    ...
    \multicolumn{1}{|c|}{\textbf{II }} & \begin{tabular}[c]{@{}l@{} p{2cm}}Compreender a proposta de redação e aplicar conceitos \\ das, várias áreas de conhecimento para desenvolver o \\ tema, dentro,dos limites estruturais do texto \\ dissertativo-argumentativo em prosa.\end{tabular} & \textit{200}            \\ \hline
  ...
  \begin{frame}[fragile]{Bag-of-words}
    \begin{figure}[H]
        ...
        \end{center}
    \end{figure}
    Matsubara, Martins e Monard (2003) explicam, um dos \textbf{métodos} 
    adotados para simplificar a \textbf{representação textual}, é a abordagem 
    \textit{bag-of-words} \cite{matsubara2003pretext}.
  \end{frame}
