\section{Trabalhos Relacionados}
  ...
  \begin{frame}[fragile]{Bag-of-words}
    \begin{figure}[H]
        ...
        \end{center}
    \end{figure}
    Matsubara, Martins e Monard (2003) explicam, um dos métodos adotados para
    simplificar a representação textual, é a abordagem \textit{bag-of-words}
    \cite{matsubara2003pretext}.
  \end{frame}
